# Web Development 2 — ACT-AD Class Materials
...
All lesson presentations include responsive viewing improvements:

- Full-screen slide backgrounds without clipped transparent edges
- Fit-to-screen layout on desktop and landscape devices
- Enlarged reading mode on portrait phones
- Horizontal panning for wide slide content
- Browser pinch-to-zoom enabled up to 5x

For the best phone experience, students may rotate the device to landscape to see the full slide or stay in portrait and swipe horizontally while reading.


## Course copy

This is a separate Web Development 2 (ACT-AD) copy. Lesson content is retained from the source materials; only course-title identifiers were changed.
